...
def makeGoodCsvFiles():
    ...
    for i in range (len(list_of_good_data_folders)):
        path='data/good/'+list_of_good_data_folders[i]+'/'+list_of_goodData_file_names[i]
...
def makeBadCsvFiles():
    ...
    for i in range(len(list_of_bad_data_folders)):
        path = 'data/bad/' + list_of_bad_data_folders[i] + '/' + list_of_badData_file_names[i]
